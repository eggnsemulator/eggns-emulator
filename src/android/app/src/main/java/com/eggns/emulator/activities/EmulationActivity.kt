...
package com.eggns.emulator.activities
...
import com.eggns.emulator.fragments.EmulationFragment
...
import com.eggns.emulator.databinding.ActivityEmulationBinding
import com.eggns.emulator.dialogs.NetPlayDialog
...
import com.eggns.emulator.network.NetPlayManager
import com.eggns.emulator.utils.InputHandler
import com.eggns.emulator.utils.Log
import com.eggns.emulator.utils.MemoryUtil
import com.eggns.emulator.utils.NativeConfig
import com.eggns.emulator.utils.NfcReader
import com.eggns.emulator.utils.ParamPackage
import com.eggns.emulator.utils.ThemeHelper
import java.text.NumberFormat
import kotlin.math.roundToInt
import com.eggns.emulator.utils.ForegroundService
...
class EmulationActivity : AppCompatActivity(), SensorEventListener, InputManager.InputDeviceListener {
    ...
    private fun notifyControllerInput() {
        ...
        val emulationFragment =
            navHostFragment?.childFragmentManager?.fragments?.firstOrNull() as? com.eggns.emulator.fragments.EmulationFragment
    ...
    override fun dispatchTouchEvent(event: MotionEvent): Boolean {
        ...
        val emulationFragment = navHostFragment?.childFragmentManager?.fragments?.firstOrNull() as? com.eggns.emulator.fragments.EmulationFragment
