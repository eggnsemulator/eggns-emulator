...
package com.eggns.emulator.ui.main
...
import com.eggns.emulator.databinding.ActivityMainBinding
import com.eggns.emulator.dialogs.NetPlayDialog
import com.eggns.emulator.features.settings.model.Settings
import com.eggns.emulator.fragments.AddGameFolderDialogFragment
...
import com.eggns.emulator.model.TaskViewModel
import com.eggns.emulator.utils.*
...
import com.eggns.emulator.updater.APKDownloader
import com.eggns.emulator.updater.APKInstaller
...
class MainActivity : AppCompatActivity(), ThemeProvider {
    ...
    fun processExternalContentDir(result: Uri) {
        ...
        val folder = gamesViewModel.folders.value.firstOrNull {
            it.uriString == uriString && it.type == com.eggns.emulator.model.DirectoryType.EXTERNAL_CONTENT
        }
        if (folder != null) {
            Toast.makeText(
                applicationContext,
        ...
        val externalContentDir = com.eggns.emulator.model.GameDir(uriString, false, com.eggns.emulator.model.DirectoryType.EXTERNAL_CONTENT)
